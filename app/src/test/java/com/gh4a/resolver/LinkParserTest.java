...
public class LinkParserTest {
    ...
    public void githubLink__opensMainActivity() {
        assertRedirectsTo(parseLink("https://github.com"), Github4AndroidActivity.class);
    }
    ...
    private static void assertRedirectsTo(LinkParser.ParseResult result, Class<?> cls) {
        assertThat("Parse result is null", result, is(notNullValue()));
        assertThat("Load task is not null", result.loadTask, is(nullValue()));
    ...
    private static void assertRedirectsToBrowser(LinkParser.ParseResult result) {
        assertThat("Parse result does not redirect to browser", result, is(nullValue()));
    }
